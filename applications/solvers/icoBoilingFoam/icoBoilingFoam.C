...
int main(int argc, char *argv[])
{
    ...
    while (runTime.run())
    {
        ...
        // {
        //     // 获取引用
        //     volScalarField& refine = solidRefineFields[i]; // 如果你用了 PtrList
        //     // 或者 lookupObject
        //     // volScalarField& refine = const_cast<volScalarField&>(solidRegions[i].lookupObject<volScalarField>("refine"));
            
        //     // 强制归零
        //     refine == dimensionedScalar(dimless, 0.0);
